...
const SummaryForm = () => {
    ...
    return (
        <form action={formAction} className="flex flex-col gap-4 h-full w-2/3 self-center">
            <input required type="text" name="title" placeholder="Título do Meu Novo Resumo" className={`bg-transparent text-3xl text-gray-800 ${inter.className} border-gray-300 p-2 focus:border-amber-400 outline-none rounded`} />
